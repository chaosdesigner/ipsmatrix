...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { name_cz: @feature.name_cz, name_en: @feature.name_en, order: @feature.order } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { name_cz: @feature.name_cz, name_en: @feature.name_en, order: @feature.order } }
