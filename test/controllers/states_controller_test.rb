...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create state' do
    assert_difference('State.count') do
      post states_url,
           params: { state: { character_id: @state.character_id, entity_id: @state.entity_id, image: @state.image,
                              sex_id: @state.sex_id, value_max: @state.value_max, value_min: @state.value_min } }
    end
